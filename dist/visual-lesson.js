import {createFlight,rng} from './engine3d.js?v=9.2';
import {renderScreens,renderRetinas} from './perception.js?v=9.2';
import {EMBODIED_INPUTS,EYE_PIXELS,RETINA_WIDTH as W} from './sensory-inputs.js?v=9.2';
