...
import {FullTrainer,validCheckpoint} from './full-controller.js?v=8.4';
...
async function train(data){
 ...
 try{
  ...
  trainer=new FullTrainer(network,data.checkpoint);trainer.scenario=data.scenario;trainer.style=data.style;trainer.variability=Number.isFinite(data.variability)?data.variability:.4;trainer.profiles=data.profiles??[data.scenario];
  let last=0;
