...
import {FullTrainer,validCheckpoint} from './full-controller.js?v=7.3';
...
async function train(data){
 ...
 try{
  ...
  trainer=new FullTrainer(network,data.checkpoint);trainer.scenario=data.scenario;trainer.style=data.style;trainer.profiles=data.profiles??[data.scenario];
  let last=0;
