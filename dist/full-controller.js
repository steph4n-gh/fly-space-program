import {collectLesson,lessonLoss,fitLesson} from './visual-lesson.js?v=9.6';
import {sampleEmbodied} from './perception.js?v=9.6';
import {FLIGHT_PANEL} from './flight-instruments.js?v=9.6';
import {EMBODIED_CONTROLLER,EMBODIED_SCHEMA,EMBODIED_INPUTS} from './sensory-inputs.js?v=9.6';
import {createFlight,fullSensors,advance,rng,decisionSteps} from './engine3d.js?v=9.6';
