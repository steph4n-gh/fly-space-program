import {collectLesson,lessonLoss,fitLesson} from './visual-lesson.js?v=9.2';
import {sampleEmbodied} from './perception.js?v=9.2';
import {EMBODIED_CONTROLLER,EMBODIED_SCHEMA,EMBODIED_INPUTS} from './sensory-inputs.js?v=9.2';
import {createFlight,fullSensors,advance,rng,decisionSteps} from './engine3d.js?v=9.2';
...
export function* rollout(network,weights,seed,scenario,style=true,variability=0,activationGain=1,inputMode='telemetry',autoOdor=true,eyesCovered=false){
 network.setInputMode(inputMode);const s=createFlight(seed,scenario,variability);s.styleEnabled=style;s.autoOdor=autoOdor;s.eyesCovered=eyesCovered;s.activationGain=activationGain;network.setActivationGain(activationGain);network.reset();
