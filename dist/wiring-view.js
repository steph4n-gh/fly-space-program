...
export class WiringView{
 constructor(root,onSelect){
  ...
  root.querySelector('#wiring-diagram').innerHTML=`<svg viewBox="0 0 1000 437" role="img" aria-label="Measured incoming connections feed output neurons, then a learned control readout and an authored limb linkage"><defs><marker id="wire-arrow" viewBox="0 0 10 10" refX="9" refY="5" markerWidth="5" markerHeight="5" orient="auto-start-reverse"><path d="M0 0 L10 5 L0 10z" fill="context-stroke"/></marker></defs><text x="10" y="22" class="wire-heading">MEASURED CONNECTIONS</text><text x="345" y="22" class="wire-heading">OUTPUT NEURONS</text><text x="660" y="22" class="wire-heading">TRAINED READOUT</text><text x="850" y="22" class="wire-heading">LIMB LINKAGE</text>${links.join('')}${sources.join('')}${motors.join('')}<rect x="650" y="151" width="171" height="113" rx="10" class="wire-command"/><text x="666" y="177" id="wire-control-name"></text><text x="666" y="215" class="wire-big" id="wire-command"></text><text x="666" y="241" class="wire-small">tanh of all 2,129 rates</text><path class="linkage-link" d="M821 208 H850"/><rect x="850" y="158" width="143" height="100" rx="9" class="wire-limb"/><text x="861" y="187" id="wire-limb-name"></text><text x="861" y="215" class="wire-small">Highlighted in cockpit</text><text x="861" y="239" class="wire-small">Control travel + IK</text><text x="345" y="427" class="wire-small">Four largest contributions shown; every output cell is included.</text></svg>`;
