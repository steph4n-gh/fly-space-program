import {PERCEPTION_SIGNALS,EMBODIED_SCHEMA} from './sensory-inputs.js?v=9.4';
import {SIGNALS,SENSOR_SCHEMA} from './signals.js?v=9.4';
import {sensorSnapshot} from './engine3d.js?v=9.4';
export {SIGNALS};
