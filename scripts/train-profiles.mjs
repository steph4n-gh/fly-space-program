...
fs.mkdirSync('/tmp/fly-v8-before-reward',{recursive:true});if(!fs.existsSync(`/tmp/fly-v8-before-reward/${name}.json`))fs.copyFileSync(file,`/tmp/fly-v8-before-reward/${name}.json`);
